...
const myTailwindTheme = {
    ...
    textarea: {
      ...
      input: 'block w-full h-20 px-3 py-3 border-none text-base text-gray-700 placeholder-gray-400 focus:shadow-outline',
    },
  ...
  export default myTailwindTheme